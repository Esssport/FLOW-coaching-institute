...
const coachHeader = ({
  ...
  textArea = "So much so that we developed a unique methodology focused on positive psychology and its 3 main pillars. In 1998 Positive Psychology became a scientific area of study. Now considered as the pioneers of Positive Psychology Martin Seligman and Mihaly Csikszentmihalyi clearly drew a line between the disease model of the early psychologists and the positive model that we understand today. Before Positive Psychology, for years, psychologists had studied the human psyche and classified groups of behaviors and attitudes into illnesses, diseases or disorders. Our method is part of the change where we’re not putting people’s defects in the spotlight, as the modern psychology practice required. Rather, we’re focused on the character strengths and behaviors that allow you and your clients to build a life of meaning and purpose. Not only will you learn how to be in the coaching seat, but you’ll also get to experience what being coached truly means.",
